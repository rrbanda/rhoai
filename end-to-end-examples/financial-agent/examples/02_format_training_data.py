...
def _to_native(obj):
    """Recursively convert numpy/pyarrow types to native Python types."""
    import numpy as np
...
def main() -> None:
    ...
    for idx, row in df.iterrows():
        tool_trace = _to_native(row["extract_agent_text_tool_trace"])
        tool_list = _to_native(row["tool_list"])
